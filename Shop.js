...
function ShowItemList(itemList,i)
{
	...
	pic.setAttribute("src", itemList[0]["picSrc"]);
...
function CreateItemList()
{
	...
	for(var i = 0 ; i<NumofItem ; i++)
	{
		if(i == 0)
		{
			...
			itemList[i] = (ItemObject("Unchosen",ownState,"DEMO",0,"Shop/pic/item/sce00.png","免費試玩"));
		}
		if(i == 1)
		{
			var ownState;
			...
			itemList[i] = (ItemObject("Unchosen",ownState,"登大人",0,"Shop/pic/item/sce01.png","免費贈送"));
		}
		if(i == 2)
		{
			var ownState;
			...
			itemList[i] = (ItemObject("Unchosen",ownState,"宿舍戰",3000,"Shop/pic/item/sce02.png","精彩內容"));
		}
	}
	return itemList;
}
